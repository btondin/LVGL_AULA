...
Real-time accelerometer chart using **LVGL** on **Zephyr RTOS** with an **NXP FXOS8700CQ** sensor on a **240x320 TFT** display driven by an **ILI9341** controller via SPI.
