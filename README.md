...
Real-time accelerometer chart using **LVGL** on **Zephyr RTOS** with an **NXP FXOS8700CQ** sensor on the **NKK ISF15ACP4 SmartSwitch** - a pushbutton with a built-in 96x64 RGB OLED display.
...
- **Contrast values**: from NKK "Application Notes for the OLED Color SmartDisplay", Revision H
