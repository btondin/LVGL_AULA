# LVGL Accelerometer Chart - ST7789V 240x320 IPS TFT

Real-time accelerometer chart using **LVGL** on **Zephyr RTOS** with an **NXP FXOS8700CQ** sensor on a **240x320 IPS TFT** display driven by an **ST7789V** controller via SPI.
...
- **Display**: ST7789V 240x320 IPS TFT on SPI1
